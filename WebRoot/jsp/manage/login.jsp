...
<div id="login">
<h1>学生报道后台登录</h1>	
	<form action="${pageContext.request.contextPath }/manage_checkmanage.action" method="post">
		<p><input type="text" name="manage.ma_name" maxlength="15" id="user" placeholder="用户名"></p>
		<p><input type="password" name="manage.ma_password" maxlength="15" id="pwd" placeholder="密码"></p>
